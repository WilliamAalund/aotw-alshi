...
@onready var winner_texture = $WinnerHorse
...
func play_victory_screen(horse_name: String, horse_texture: Texture2D) -> void:
	winner_name.text = horse_name + " won!"
	winner_texture.texture = horse_texture
...
func _on_finish_game(horse_name: String, horse_texture: Texture2D) -> void:
	play_victory_screen(horse_name, horse_texture)
